...
下面是当前 MVP 使用的卡通视觉素材，已用于宠物图鉴、家园和我的宠物页面。后续补充正式 UI 截图后，可以继续放在这里展示。

### 金毛成长形象

![金毛成长形象](public/pets/golden-growth.png)

### 猫咪成长形象

![猫咪成长形象](public/pets/cat-growth.png)

### 异宠合集形象

![异宠合集形象](public/pets/exotic-collection.png)
